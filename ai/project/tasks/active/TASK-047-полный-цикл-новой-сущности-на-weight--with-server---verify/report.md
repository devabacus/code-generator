...
- [ ] Результат дописан в `weight-migration-probe-2026-07-28.md` — **блокировано**: файл живёт
      только в открытом PR #56, в master его нет
...
Готово. Осталось дописать результат в probe-документ — после merge PR #56.
