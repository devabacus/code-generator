...
**Дата:** 2026-04-17 (создан) / 2026-04-18 (перенесён в `ai/docs/decisions/`)
**Статус:** Предложено (ждёт approval User)
**Оригинал:** [`docs-code-generator/decisions/adr-0001-logger-in-templates.md`](../../../docs-code-generator/decisions/adr-0001-logger-in-templates.md)
