...
| TASK-052 | Убрать из шаблонов t115 и simplified мёртвые handleSyncEvent, reconcileServerChanges и BaseSyncRepository — иначе генератор возвращает их в проекты | 🟡 In Progress | 2026-08-01 |
